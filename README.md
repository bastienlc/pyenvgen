...
1. Schemas are defined in a YAML file. They include validation rules based on [environs](https://github.com/sloria/environs) and custom generation rules.
...
Validation rules are a simple YAML representation of the validation rules supported by the [environs](https://github.com/sloria/environs) library.
